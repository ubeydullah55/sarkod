            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body pt-4 p-3">
                        ...
                        <!-- Form Başlangıcı -->
                        <form method="POST" action="<?= site_url('admin/yeniModelSave') ?>" enctype="multipart/form-data">
                            <div class="row">
                                <!-- Bilezik Resmi -->
                                <div class="col-4"></div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="bilezikBasGr" name="bilezik_bas_gr" placeholder="Başlangıç Gramı Girin" step="0.01" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="bilezikBitGr" name="bilezik_bit_gr" placeholder="Bitiş Gramı Girin" step="0.01" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="bilezikGenislik" name="bitis_bilezikgenislik" placeholder="Bitiş Genişlik Girin" step="0.01" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="bilezikCNC" name="bilezik_cnc" placeholder="CNC Bilgisini Girin" required>
                                    </div>
                                </div>
