...
class SiparisOlusturController extends BaseController
{
    ...
    public function yeniModelSave()
    {
        ...
        // Seçili olan bilezik ID'sini ekrana yazdır (test amaçlı)
        echo "Seçilen Bilezik ID: " . $bilezikID;
        die();
        ...
        if ($resim && $resim->isValid() && !$resim->hasMoved()) {
            ...
            $resim->move(FCPATH . 'customerProducts', $randomName);
